...
const dom = (() => {
  ...
  function renderProjects() {
    ...
    if (!localStorage.getItem('projects')) {
      _projects__WEBPACK_IMPORTED_MODULE_0__["default"].addProject('Default project');
    } else {
      const projectsFromStorage = JSON.parse(localStorage.getItem('projects'));
      _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList = projectsFromStorage;
    }
  ...
  function renderTodos(projectIndex) {
    ...
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].todos.forEach(function (todo) {
      const template = `
  ...
  function renderTodoDetails (todoDiv, projectIndex, todoIndex) {
    const todo = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].todos[todoIndex];
  ...
  function renderAddProjectForm(projectIndex) {
    ...
    if (arguments.length === 1) {
      const project = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex];
    ...
    document.querySelector('.close-project-button').addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].closeAddProjectForm);
    document.querySelector('.submit-project-button').addEventListener('click', (e) => {
      if (e.target.id === 'edit-project-submit-button') {
        _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].submitProjectForm(e, projectIndex);
      } else {
        _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].submitProjectForm(e);
      }
    })
  }
  ...
  function renderAddTodoForm(projectIndex, todoIndex) {
    ...
    document.querySelector('.close-todo-button').addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].closeAddTodoForm);
    document.querySelector('.submit-todo-button').addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].submitTodoForm);
  }

  function addAddNewProjectEventListener () {
    document.querySelector('.add-project-button').addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].openAddProjectForm);
  }

  function addAddNewTodoEventListener () {
    document.querySelector('.add-todo-button').addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].openAddTodoForm);
  }

  function addSelectProjectEventListeners () {
    const projectDivs = document.querySelectorAll('.project-name');
    projectDivs.forEach((project) => project.addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].selectProject));
  }

  function addToggleTodoDetailsEventListeners () {
    const todoDivs = document.querySelectorAll('.todo-name');

    todoDivs.forEach((todo) => todo.addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].toggleTodoDetails));
  }

  function addDeleteTodoEventListeners () {
    const deleteIcons = document.querySelectorAll('.fa-trash');

    deleteIcons.forEach((icon) => icon.addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTodo));
  }

  function addToggleCompleteTodoEventListeners () {
    const completedIcons = document.querySelectorAll('.fa-circle-check');

    completedIcons.forEach((icon) => icon.addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].toggleComplete));
  }

  function addEditTodoEventListeners () {
    const editIcons = document.querySelectorAll('.fa-pen-to-square.edit-todo');

    editIcons.forEach((icon) => icon.addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].openAddTodoForm));
  }

  function addEditProjectEventListeners () {
    const editIcons = document.querySelectorAll('.fa-pen-to-square.edit-project');

    editIcons.forEach((icon) => icon.addEventListener('click', _handlers__WEBPACK_IMPORTED_MODULE_1__["default"].openAddProjectForm));
  }
...
const handlers = (() => {
  ...
  function selectProject(e) {
    if (e.target.classList.contains('project-name')) {
      ...
      _dom__WEBPACK_IMPORTED_MODULE_0__["default"].renderTodos(projectIndex);
    }
  }
  ...
  function submitProjectForm(e, projectIndex) {
    ...
    if (title.reportValidity()) {
      if (e.target.id === 'edit-project-submit-button') {
        _projects__WEBPACK_IMPORTED_MODULE_1__["default"].editProject(title.value, projectIndex);
      } else {
        _projects__WEBPACK_IMPORTED_MODULE_1__["default"].addProject(title.value);
      }
  ...
  function submitTodoForm(e) {
    ...
    if (title.reportValidity()) {
      if (e.target.id === 'edit-todo-submit-button') {
        ...
        _todos__WEBPACK_IMPORTED_MODULE_2__["default"].editTodo(title.value, description.value, dueDate.value, priority.value, projectIndex, todoIndex);
      } else {
        _todos__WEBPACK_IMPORTED_MODULE_2__["default"].addTodo(title.value, description.value, dueDate.value, priority.value, false, projectIndex);
      }
  ...
  function openAddProjectForm(e) {
    ...
    if (!document.getElementById('add-project-form')) {
      if (e.target.classList.contains('edit-project')) {
        _dom__WEBPACK_IMPORTED_MODULE_0__["default"].renderAddProjectForm(e.target.parentElement.dataset.projectIndex);
      } else {
        _dom__WEBPACK_IMPORTED_MODULE_0__["default"].renderAddProjectForm();
      }
    }
  }
  ...
  function openAddTodoForm(e) {
    ...
    if (!document.getElementById('add-todo-form')) {
      if (e.target.classList.contains('fa-pen-to-square')) {
        ...
        _dom__WEBPACK_IMPORTED_MODULE_0__["default"].renderAddTodoForm(projectIndex, todoIndex);
      } else {
        _dom__WEBPACK_IMPORTED_MODULE_0__["default"].renderAddTodoForm();
      } 
    }
  }
  ...
  function deleteTodo (e) {
    ...
    _todos__WEBPACK_IMPORTED_MODULE_2__["default"].deleteTodo(projectIndex, todoIndex);
    localStorage.setItem('projects', JSON.stringify(_projects__WEBPACK_IMPORTED_MODULE_1__["default"].projectList));
  ...
  function toggleComplete (e) {
    ...
    _todos__WEBPACK_IMPORTED_MODULE_2__["default"].toggleComplete(projectIndex, todoIndex);
    localStorage.setItem('projects', JSON.stringify(_projects__WEBPACK_IMPORTED_MODULE_1__["default"].projectList));
    if (todoDiv.nextElementSibling.children.length !== 0) {
      _dom__WEBPACK_IMPORTED_MODULE_0__["default"].renderTodoDetails(todoDiv, projectIndex, todoIndex);
    }
  }
...
const todos = (() => {
  ...
  class Todo {
    constructor(title, description, dueDate, priority, completed, projectIndex) {
      ...
      this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(dueDate), 'yyyy-MM-dd');
  ...
  function addTodo(title, description, dueDate, priority, completed, projectIndex) {
    ...
    (_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].todos).push(todo);
    todo.index = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].todos.indexOf(todo);
  }

  function getTodoIndex(titleInput) {
    const index = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[_projects__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectIndex('Test project')].todos.map(todo => todo.title).indexOf(titleInput);
    return index;
  }

  function deleteTodo(projectIndex, todoIndex) {
    const todoList = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].todos;
  ...
  function toggleComplete(projectIndex, todoIndex) {
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].todos[todoIndex].completed = !_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].todos[todoIndex].completed
  }
...
_dom__WEBPACK_IMPORTED_MODULE_2__["default"].renderHeader();
_dom__WEBPACK_IMPORTED_MODULE_2__["default"].renderProjects();
